...
public class TestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String inputPassword = req.getParameter("password"); //henter parameter fra password-indtastningsfeltet i indexfile
        //   Patient bruger = forbindelse.searchUser(inputBruger);
        //   Patient pass = forbindelse.searchUser(inputPassword);
